...
namespace FSFLauncherA3
{
    public partial class langue : Form
    {
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                FSFLauncherCore.SetKeyValue(@"Software\Clan FSF\FSF Launcher A3\", "langage", "fr-FR");
            };
        }
        ...
        private void radioButton2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                FSFLauncherCore.SetKeyValue(@"Software\Clan FSF\FSF Launcher A3\", "langage", "en-US");
            };
        }
        ...
        private void radioButton3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                FSFLauncherCore.SetKeyValue(@"Software\Clan FSF\FSF Launcher A3\", "langage", "de-DE");
            };
        }
        ...
        private void radioButton4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                FSFLauncherCore.SetKeyValue(@"Software\Clan FSF\FSF Launcher A3\", "langage", "ru-RU");
            };
        }
